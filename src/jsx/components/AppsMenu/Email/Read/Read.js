    ...
    <Fragment>
      ...
      <div className='row'>
        <div className='col-lg-12'>
          <div className='card read-page'>
            <div className='card-body p-0'>
              <div class="row">
                  <div class="col-lg-3">
                    <div className='email-left-box generic-width p-4 mb-5'>
                      <div className='p-0'>
                        <Link
                          to='/email-compose'
                    ...
                    <div className='email-right-box'>
                      ...
                      <div className='row'>
                        <div className='col-12'>
                          <div className='right-box-padding p-4'>
                              ...
                              <div className='read-content-attachment'>
                                ...
                                <div className='row attachment'>
                                  <div className='col-auto'>
                                    <Link to='/email-read' className='btn btn-outline-primary btn-xs'>
                                      My-Photo.png
                                    </Link>
                                  </div>
                                  <div className='col-auto'>
