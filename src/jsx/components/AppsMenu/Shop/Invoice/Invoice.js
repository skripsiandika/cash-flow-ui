...
import logoTextlight from "../../../../../images/logo-text.png";
                      ...
                      <div className="brand-logo mb-3">
                        <img className="logo-abbr me-2" src={logo} alt="" style={{width:'50px'}}  />
                          {background.value === "dark" ?
                            ...
                            <img className="logo-compact" src={logoText} alt="" style={{width:'60px'}} /> 
                            :
                            <img className="logo-compact" src={logoTextlight} alt="" style={{width:'60px'}} />
                          }  
                      </div>
                      <span>
