...
const ticketData = [
  ...
  { title: 'Louis Jovanny', gender: 'Male', type: 'Personal', Rgdate: '13 Jan, 2023', Expdate: '15 Jan, 2023' },
  { title: 'Cindy Hawkins', gender: 'Female', type: 'Badan Usaha', Rgdate: '14 Jan, 2023', Expdate: '16 Jan, 2023' },
  { title: 'Glee Smiley', gender: 'Male', type: 'Personal', Rgdate: '17 Jan, 2023', Expdate: '19 Jan, 2023' },
  { title: 'Timothy L. Brodbeck', gender: 'Male', type: 'Badan Usaha', Rgdate: '18 Jan, 2023', Expdate: '20 Jan, 2023' },
  { title: 'Louis Jovanny', gender: 'Male', type: 'Personal', Rgdate: '21 Jan, 2023', Expdate: '23 Jan, 2023' },
  { title: 'Timothy L. Brodbeck', gender: 'Female', type: 'Badan Usaha', Rgdate: '22 Jan, 2023', Expdate: '24 Jan, 2023' },
  { title: 'Cindy Hawkins', gender: 'Male', type: 'Badan Usaha', Rgdate: '25 Jan, 2023', Expdate: '27 Jan, 2023' },
  { title: 'Louis Jovanny', gender: 'Male', type: 'Personal', Rgdate: '26 Jan, 2023', Expdate: '28 Jan, 2023' },
  { title: 'Cindy Hawkins', gender: 'Female', type: 'Badan Usaha', Rgdate: '29 Jan, 2023', Expdate: '30 Jan, 2023' },
];
    ...
    <>
      <div className="row page-titles">
        <ol className="breadcrumb">
          <li className="breadcrumb-item active"><Link to={"#"}> Registrations</Link></li>
          <li className="breadcrumb-item"><Link to={"#"}> SME List</Link></li>
        </ol>
      </div>
      <div className="row">
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header">
              <h4 className="card-title">SME List</h4>
              <Link to={"/create-sme"} className="btn btn-primary">Add SME</Link>
            </div>
                  ...
                  <div className='d-flex justify-content-between mb-3 custom-tab-list'>
                    <div className='d-flex align-items-center'>
                      ...
                      <Dropdown className="search-drop">
                        <Dropdown.Toggle className="">5</Dropdown.Toggle>
                        <Dropdown.Menu>
